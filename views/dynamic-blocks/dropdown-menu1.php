...
$menu_item_tpl =
    '<div class="row">'
        .'<div class="col-md-8">{title} '
            .'<a href="#w0" class="add-link-btn" title="Добавить пункт в подменю" data-toggle="modal" data-itemlevel="2">'
...
<div class="dynblock-menu">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    <a href="#w0" class="add-link-btn btn btn-primary" title="Добавить пункт меню" data-toggle="modal" data-itemlevel="1">
...
//    alert( $(e.relatedTarget).data('itemlevel') );
    refreshForm();
});
...
// $('body').on('click', 'a.add-link-btn', function(ev){
// //$('a.add-link-btn').on('click', function(ev){
//     $('#w0').modal('show');
// });
